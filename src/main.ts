...
// Websocket Setup
function setupWebsocket(baseUrl: string) {
...
async function uploadImage(file: File, baseUrl: string) {
...
async function triggerPrompt(promptWorkflow: any, baseUrl: string) {
...
async function pollHistory(promptId: string, baseUrl: string): Promise<any> {
...
function findOutputImage(historyData: any) {
